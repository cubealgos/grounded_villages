...
|---|---|
| `root` | `src/fabric/java`, `src/fabricgametest/java`, `src/forge/java`, `src/gametest/java`, `src/main/java`, `src/neoforge/java`, `src/neoforgegametest/java`, `src/seedsweep/java`, `src/test/java` |
